...
let velocity1 = 0
let velocity2 = 0
let sharkbig: Sprite = null
let fish: Sprite = null
let direction = 0
let shark: Sprite = null
game.splash("Eat fish for 1 minute.")
...
game.onUpdateInterval(randint(10000, 15000), function () {
    sharkbig = sprites.create(img`
        ...
        `, SpriteKind.Enemy)
    if (randint(0, 1) == 0) {
        sharkbig.setPosition(-8, randint(15, 100))
        sharkbig.setVelocity(velocity2, 0)
    } else {
        sharkbig.setPosition(168, randint(15, 100))
        sharkbig.setVelocity(velocity1, 0)
    }
})
game.onUpdateInterval(2100, function () {
    if (randint(0, 1) == 0) {
        fish = sprites.create(img`
            ...
            . . . . . . . . . . . . . . . . 
            `, SpriteKind.Food)
        fish.setPosition(-8, randint(15, 100))
        ...
        fish = sprites.create(img`
            ...
            . . . . . . . . . . . . . . . . 
            `, SpriteKind.Food)
        fish.setPosition(168, randint(15, 100))
        fish.setVelocity(velocity1, 0)
    }
})
game.onUpdateInterval(2100, function () {
    velocity1 = randint(-100, -80)
    velocity2 = randint(80, 100)
    if (info.score() >= 10) {
        velocity1 = randint(-120, -100)
        velocity2 = randint(100, 120)
    } else if (info.score() >= 15) {
        velocity1 = randint(-175, -120)
        velocity1 = randint(120, 175)
    }
})
